...
====================================================
OUTPUT LANGUAGE
Write ALL generated text content in {language}. This applies to every
...
can still be parsed correctly. Only the text VALUES should be in {language}.

Mathematical/scientific notation — numbers, operators, symbols such as
+, -, =, ^, ∩, ∪, ⊆, %, and formula variable names (like x, y, A, B) —
should stay in standard international notation even when the surrounding
explanation is in {language}. The "correct_answer" field for MCQs must
still be exactly one of the letters A, B, C, or D, regardless of language.
====================================================
"""
